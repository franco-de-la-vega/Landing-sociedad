    ...
    <section className="relative border-t border-[var(--color-border)] px-6 py-24 md:px-10 md:py-32">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 lg:grid-cols-2">
          <Reveal delay={0.1}>
            <div className="h-full rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-elevated)] p-9">
              <span className="inline-flex items-center gap-2 rounded border border-[var(--color-border)] bg-black/[0.04] px-3.5 py-2 text-[12px] uppercase tracking-widest text-[var(--color-text-secondary)]">
                No es para vos si...
              </span>

              <RevealGroup stagger={0.1} className="mt-9 flex flex-col gap-7">
          ...
          <Reveal delay={0.16}>
            <div className="h-full rounded-2xl border border-[var(--color-accent)]/40 bg-[var(--color-bg-elevated)] p-9 shadow-[0_20px_45px_-24px_rgba(20,18,14,0.18)]">
              <span className="inline-flex items-center gap-2 rounded border border-[var(--color-accent)]/25 bg-[var(--color-accent)]/[0.06] px-3.5 py-2 text-[12px] uppercase tracking-widest text-[var(--color-accent)]">
                Es para vos si...
              </span>
        ...
        <Reveal delay={0.1} className="mt-10">
          <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-bg-elevated-2)] p-10 text-center">
            <p className="mx-auto max-w-2xl text-[18px] italic leading-relaxed text-[var(--color-text-secondary)]">
